...
" Latex
autocmd FileType rmd,markdown inoremap ;M $$$$<Enter><Enter><++><Esc>2k$hi
autocmd Filetype tex          inoremap ;M \[  \]<Esc>hhi
autocmd FileType tex,rmd,markdown inoremap ;m $$<Space><++><Esc>2T$i
autocmd FileType tex,rmd,markdown inoremap ;a \begin{align*}<Enter>\end{align*}<Enter><++><Esc>kO
