...
theme.wallpaper = os.getenv("HOME") .. "/.wallpapers/minimal/mikael_gustafsson_small_memory.png"

-- Set the theme font. This is the font that will be used by default in menus, bars, titlebars etc.
theme.font          = "sans 11"
theme.fancy_font    = "M+ 1c"
...
theme.sidebar_font = "Titillium Web"
theme.sidebar_time_font = "Titillium Web"
