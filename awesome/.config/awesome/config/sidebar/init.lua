...
local weather_widget = require("config.sidebar.weather")
...
local mpris_song = require("config.sidebar.mpris")
...
local volume = require("config.sidebar.volume")
local cpu = require("config.sidebar.cpu")
local temperature = require("config.sidebar.temperature")
local ram = require("config.sidebar.ram")
local battery = require("config.sidebar.battery")
local disk = require("config.sidebar.disk")
