...
keys.buttons = gears.table.join(
	...
	awful.button({ }, 2, function () sidebar.visible = not sidebar.visible end),
    ...
    awful.button({ }, 8, function () helpers.volume_control("down") end),
    awful.button({ }, 9, function () helpers.volume_control("up") end)
)
-- }}}
